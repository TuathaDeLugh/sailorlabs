...
function Avatar({ name, index }: { name: string; index: number }) {
  const palettes = [
    {
      bg: "bg-[rgba(232,180,184,0.25)]",
      border: "border-[var(--color-primary)]",
      color: "var(--color-primary-dark)",
    },
    {
      bg: "bg-[rgba(168,213,186,0.25)]",
      border: "border-[var(--color-secondary)]",
      color: "var(--color-secondary-dark)",
    },
    {
      bg: "bg-[rgba(212,175,55,0.18)]",
  ...
  return (
    <div
      className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-2 ${p.bg} ${p.border}`}
      aria-hidden="true"
    >
      <span
...
export default function Testimonials() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent via-[rgba(168,213,186,0.04)] to-transparent"
      />
      ...
      <div className="relative mx-auto max-w-[1200px]">
        ...
        >
          ...
          <h2
            ...
            className="font-heading text-4xl font-medium text-[var(--color-text)] md:text-5xl"
          >
            Loved by&nbsp;
          ...
          <p className="mx-auto mt-3 max-w-[540px] font-body text-base leading-[1.75] text-[var(--color-text-muted)]">
            From developers to creators — here's what they're building with
            Sailor Labs products.
          </p>
        </motion.div>
          ...
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-heading text-base font-semibold leading-tight text-[var(--color-text)]">
                    {t.name}
                  </p>
                  <p className="mt-0.5 font-body text-[0.75rem] tracking-[0.04em] text-[var(--color-text-muted)]">
                    {t.role}
                  </p>
                </div>
              </div>
