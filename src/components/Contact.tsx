...
function InfoItem({
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="font-body text-[0.68rem] font-bold uppercase tracking-widest text-(--color-text-subtle)">
          {label}
        </p>
        {href ? (
          <a
            href={href}
            className="font-body text-sm text-(--color-text) no-underline transition-colors duration-200 hover:text-(--color-primary-dark)"
          >
            {value}
          </a>
        ) : (
...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-40 bottom-0 h-100 w-100 rounded-full bg-[rgba(232,180,184,0.06)] blur-[120px]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-40 top-0 h-87.5 w-87.5 rounded-full bg-[rgba(168,213,186,0.05)] blur-[100px]"
      />
      ...
      <div className="relative mx-auto max-w-300">
        ...
        >
          ...
          <p className="mx-auto mt-3 max-w-135 font-body text-base leading-[1.75] text-(--color-text-muted)">
            Bug report, feature request, partnership inquiry, or just want to
        ...
        >
          ...
          >
            <div className="neu-card flex flex-col gap-5 p-8">
              <div>
                <h3 className="mb-1.5 font-heading text-[1.4rem] font-medium text-(--color-text)">
                  Get in touch
                </h3>
                <p className="font-body text-sm leading-relaxed text-(--color-text-muted)">
                  Our team responds within one business day. Reach out via any
                  channel below.
                </p>
              </div>
              ...
              <InfoItem
                ...
                value="hello@sailorlabs.in"
                href="mailto:hello@sailorlabs.in"
              />
              <InfoItem
                icon={
                  <svg
                ...
                label="Bugs & contributions"
                value="github.com/sailorlabs"
              ...
              <InfoItem
                ...
                value="discord.gg/sailorlabs"
                href="https://discord.gg/sailorlabs"
              />
              ...
              <div className="rounded-xl border border-(--color-border) bg-(--color-bg) p-4">
                {[
                  ...
                  >
                    <span className="font-body text-[0.8rem] text-(--color-text-muted)">
                      {r.label}
                    </span>
                    <span className="font-body text-[0.8rem] font-semibold text-(--color-secondary-dark)">
                      {r.val}
                    </span>
                  </motion.div>
                ))}
          ...
          >
            {sent ? (
              ...
              <form onSubmit={onSubmit} noValidate aria-label="Contact form">
                <h3 className="mb-6 font-heading text-[1.4rem] font-medium text-(--color-text)">
                  Send a message
                </h3>
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    },
                    {
                      ...
                      req: false,
                      auto: "off",
                      ph: "Bug report / Feature request / Other",
                      val: form.subject,
                    },
                  ].map((f) => (
                    <div key={f.id} className="flex flex-col gap-1.5">
                      ...
                      >
                        ...
                        {f.req && (
                          <span
                            aria-hidden="true"
                            className="ml-0.5 text-(--color-primary)"
                          >
                            *
                          </span>
                        )}
