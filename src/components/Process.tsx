...
const steps = [
  {
    ...
    title: "Discovery",
    description:
      "We dive deep into your vision, goals, and challenges. Research-backed strategy meets creative thinking.",
    color: "#818cf8",
  ...
  },
  {
    ...
    title: "Design",
    description:
      "Wireframes evolve into stunning prototypes. Every pixel is deliberate, every interaction is meaningful.",
    color: "#22d3ee",
  ...
  },
  {
    ...
    title: "Develop",
    description:
      "Clean, scalable code brought to life with modern frameworks. Agile sprints keep everything on track.",
    color: "#a78bfa",
  ...
  },
  {
    ...
    title: "Deploy",
    description:
      "Rigorous testing, performance optimization, and seamless launch. Your product goes live with confidence.",
    color: "#34d399",
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="mt-5 text-lg text-[#7a7a99] max-w-2xl mx-auto leading-relaxed">
            A battle-tested workflow that turns ambitious ideas into polished
            digital products.
          </p>
        </motion.div>
            ...
            >
              <div
                className={`relative flex flex-col sm:flex-row items-start gap-6 sm:gap-8 p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-[#0d0d14]/80 border border-white/[0.06] hover:border-white/[0.1] transition-all duration-500 overflow-hidden ${
                  i % 2 !== 0
                    ? "sm:ml-auto sm:max-w-[85%] lg:max-w-[75%]"
                    : "sm:max-w-[85%] lg:max-w-[75%]"
                }`}
              >
                {/* Glow on hover */}
                <div
